...
async def health_check():
    ...
    return {
        ...
        "storage": "cloudinary-configured" if settings.cloudinary_cloud_name else "local-upload-fallback",
...
async def system_health():
    services = [
        ...
        {"name": "Storage", "status": "ok", "mode": "Cloudinary" if settings.cloudinary_cloud_name else "local"},
    ...
    return {
        ...
        "storage": {"status": "ok", "mode": "Cloudinary" if settings.cloudinary_cloud_name else "local"},
